...
{
    class TrialVisitRepository : Repository<TrialVisit>
    {
        public TrialVisitRepository(IDataProvider dataProvider)
            : base(dataProvider)
        {}
        ...
        protected override int GetItemIndex(TrialVisit item)
        {
            return Data.IndexOf(e => e.Id == item.Id);
        }

        protected override void SetNewValues(TrialVisit item)
        {
